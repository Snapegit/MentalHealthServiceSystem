			...
			<div class="data_box">
				<div class="data_view">
					<el-table v-loading="listLoading" border :stripe='true' @selection-change="handleSelectionChange" ref="table"
						...
						<el-table-column label="心理测试时长(分钟)" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.time}}
							</template>
						</el-table-column>
						<el-table-column label="操作" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								<el-button class="exam_btn" @click="examClick(scope.row.id)" size="small">开始心理测试</el-button>
							</template>
						</el-table-column>
					</el-table>
				</div>
