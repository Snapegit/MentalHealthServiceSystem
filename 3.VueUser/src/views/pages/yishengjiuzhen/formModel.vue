	...
	<div class="app-contain" :style='{"padding":"20px 20px","margin":"20px auto 40px","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">诊断问题</div>
					<div  class="info_text" >{{detail.zhenduanwenti}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">治疗方案</div>
					<div  class="info_text" >{{detail.zhiliaofangan}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">就诊时间</div>
					<div  class="info_text" >{{detail.jiuzhenshijian}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">严重程度</div>
					<div  class="info_text" >{{detail.yanzhongchengdu}}</div>
				</div>
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('yishengjiuzhen','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('yishengjiuzhen','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('yishengjiuzhen','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			...
			<el-tab-pane label="就诊详情" name="first1">
