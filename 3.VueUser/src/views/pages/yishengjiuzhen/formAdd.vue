			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="既往病史" prop="jiwangbingshi">
						<editor class="list_editor" :value="form.jiwangbingshi" placeholder="请输入既往病史" :readonly="!isAdd||disabledForm.jiwangbingshi?true:false"
							@change="(e)=>editorChange(e,'jiwangbingshi')"></editor>
					</el-form-item>
				</el-col>
				<el-col :span="24">
					<el-form-item label="就诊详情" prop="jiuzhenxiangqing">
						<editor class="list_editor" :value="form.jiuzhenxiangqing" placeholder="请输入就诊详情" :readonly="!isAdd||disabledForm.jiuzhenxiangqing?true:false"
							@change="(e)=>editorChange(e,'jiuzhenxiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.jiwangbingshi = res.data.data.jiwangbingshi.replace(reg,'../../../cl52924225/file');
			res.data.data.jiuzhenxiangqing = res.data.data.jiuzhenxiangqing.replace(reg,'../../../cl52924225/file');
