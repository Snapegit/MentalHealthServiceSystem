<template>
		...
		<div class="app-contain">
			...
			<el-table v-loading="listLoading" border :stripe='false' ref="table" :data="list">
				...
				<el-table-column label="心理测试得分" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="心理测试时间" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						{{scope.row.addtime}}
					</template>
				</el-table-column>
