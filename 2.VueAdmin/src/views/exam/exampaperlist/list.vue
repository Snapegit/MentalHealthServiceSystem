	...
	<div>
		<div class="app-contain">
			...
			<el-table v-loading="listLoading" border :stripe='false' @selection-change="handleSelectionChange" ref="table"
				...
				<el-table-column label="心理测试时长(分钟)" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						{{scope.row.time}}
					</template>
				</el-table-column>
				<el-table-column label="操作" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button type="success" @click="examClick(scope.row.id)">开始心理测试</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination
