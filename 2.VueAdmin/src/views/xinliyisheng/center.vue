					...
					<el-col :span="24">
						<el-form-item label="照片" prop="zhaopian">
							<uploads
								...
								@change="xinliyishengzhaopianUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in xinliyishengxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const tableName = ref('xinliyisheng')
	const user = ref({})
	const xinliyishengxingbieLists = ref([])
	const init = () => {
		xinliyishengxingbieLists.value = "男,女".split(',')
	}
	const xinliyishengzhaopianUploadSuccess=(fileUrls)=> {
